...
SECRET_KEY = 'django-insecure-f01!9jobh&*h^#cc*i=#u6&-$6y(j@-aiml-@0#$7_5z32yjq&'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Default: requires login unless overridden
    ],
}